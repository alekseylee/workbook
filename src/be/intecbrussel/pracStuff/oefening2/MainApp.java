...
////        public void mySize(int size, boolean complete)
//        for (int x = 0; x < shoePairs.length; x++) {
//            for (double y = 0; y <shoePairs.length; y++)
//            if (shoePairs.length[x] == 41) {
//                double sum += shoePairs.length[y];
//                System.out.println(shoePairs.length[y]);
            }
        }
